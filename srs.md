...
|:---:|:---:|:---:|---|:---:|:---:|:---:|
| **BG-01, BG-12** | BR-001 | **FR-AUTH-01** | Đăng ký tài khoản Khách hàng | UC-05 | AC-AUTH-01 | TC-REG-001, TC-REG-002, TC-REG-003, TC-REG-004, TC-REG-005 |
| **BG-01, BG-07** | BR-002 | **FR-AUTH-02** | Đăng ký tài khoản Đối tác Tài xế | UC-04, UC-05 | AC-DRV-01 | TC-REG-006, TC-REG-007 |
| **BG-12** | BR-003, BR-041 | **FR-AUTH-03** | Đăng nhập hệ thống & Cấp phát JWT | UC-05 | AC-AUTH-02 | TC-AUTH-001, TC-AUTH-002, TC-AUTH-003, TC-AUTH-004, TC-AUTH-005, TC-AUTH-006, TC-AUTH-007, TC-AUTH-008, TC-AUTH-009, TC-AUTH-010, TC-AUTH-011, TC-AUTH-012, TC-AUTH-013, TC-AUTH-014, TC-AUTH-015, TC-AUTH-016, TC-AUTH-017, TC-AUTH-018, TC-AUTH-019, TC-AUTH-020 |
| **BG-13** | BR-004 | **FR-AUTH-04** | Cập nhật thông tin hồ sơ cá nhân | UC-05 | AC-AUTH-01 | TC-ACC-001, TC-ACC-002 |
| **BG-12** | BR-042 | **FR-AUTH-05** | Đổi mật khẩu người dùng | UC-05 | AC-AUTH-02 | TC-ACC-003, TC-ACC-004 |
| **BG-12** | BR-041 | **FR-AUTH-06** | Đăng xuất & Thu hồi phiên làm việc | UC-05 | AC-AUTH-02 | TC-ACC-005 |
| **BG-07** | BR-017 | **FR-DRV-01** | Khai báo & Quản lý thông tin phương tiện | UC-04, UC-06 | AC-DRV-01 | TC-DRV-001, TC-DRV-002 |
| **BG-04, BG-07** | BR-014 | **FR-DRV-02** | Bật / Tắt trạng thái trực tuyến (Online/Offline) | UC-06 | AC-TRK-01 | TC-DRV-003, TC-DRV-004, TC-DRV-005 |
| **BG-04, BG-07** | BR-014, BR-023 | **FR-DRV-03** | Tự động chuyển trạng thái Bận (Busy) khi có cuốc | UC-02, UC-06 | AC-MCH-02 | TC-DRV-006 |
| **BG-07, BG-09** | BR-016, BR-036 | **FR-DRV-04** | Xét duyệt / Từ chối hồ sơ tài xế mới | UC-04 | AC-DRV-02 | TC-APP-001, TC-APP-002, TC-APP-003 |
| **BG-07, BG-13** | BR-013, BR-035 | **FR-DRV-05** | Xem hồ sơ hiệu suất, rating và thu nhập tài xế | UC-06 | AC-RAT-01 | TC-DRV-003, TC-ADM-001 |
| **BG-09, BG-12** | BR-036, BR-039 | **FR-DRV-06** | Khóa / Tạm đình chỉ tài khoản tài xế vi phạm | UC-04, UC-09 | AC-ADM-01 | TC-AUTH-009, TC-APP-004 |
| **BG-01, BG-13** | BR-005 | **FR-RIDE-01** | Tìm kiếm địa chỉ đón/trả & Geocoding bản đồ | UC-01 | AC-BOOK-01 | TC-EST-001, TC-EST-004 |
| **BG-01, BG-06** | BR-005, BR-025 | **FR-RIDE-02** | Tính toán & Hiển thị cước ước tính theo loại xe | UC-01 | AC-BOOK-01 | TC-EST-002, TC-EST-003, TC-EST-005 |
| **BG-01, BG-04** | BR-005, BR-012 | **FR-RIDE-03** | Khởi tạo yêu cầu đặt chuyến xe trực tuyến | UC-01 | AC-BOOK-02 | TC-BOOK-001, TC-BOOK-002, TC-BOOK-003 |
| **BG-05, BG-08** | BR-007, BR-023 | **FR-RIDE-04** | Cập nhật mốc "Tài xế đã đến điểm đón" | UC-02 | AC-RIDE-01 | TC-RIDE-001 |
| **BG-05, BG-08** | BR-007, BR-023 | **FR-RIDE-05** | Cập nhật mốc "Bắt đầu chuyến đi" | UC-02 | AC-RIDE-01 | TC-RIDE-002, TC-RIDE-004 |
| **BG-05, BG-06** | BR-007, BR-024 | **FR-RIDE-06** | Cập nhật mốc "Hoàn thành chuyến đi" | UC-02, UC-03 | AC-RIDE-01, AC-PAY-01 | TC-RIDE-003, TC-RIDE-005 |
| **BG-05, BG-13** | BR-010 | **FR-RIDE-07** | Khách hàng hủy chuyến xe | UC-07 | AC-CNC-01 | TC-CNC-001, TC-CNC-002, TC-CNC-005 |
| **BG-05, BG-07** | BR-010, BR-020 | **FR-RIDE-08** | Tài xế hủy chuyến do sự cố phương tiện/No-Show | UC-07 | AC-CNC-02 | TC-CNC-003, TC-CNC-004 |
| **BG-01, BG-13** | BR-011 | **FR-RIDE-09** | Tra cứu lịch sử & Chi tiết chuyến đi | UC-01, UC-06 | AC-BOOK-02 | TC-ACC-001, TC-PAY-006 |
| **BG-04** | BR-018, BR-019 | **FR-MATCH-01** | Quét tài xế khả dụng quanh bán kính 5km | UC-01 | AC-MCH-01 | TC-MCH-001, TC-MCH-002 |
| **BG-04** | BR-019 | **FR-MATCH-02** | Thuật toán xếp hạng ưu tiên khoảng cách & rating | UC-01 | AC-MCH-01 | TC-MCH-001 |
| **BG-04, BG-08** | BR-020, BR-021 | **FR-MATCH-03** | Gửi thông báo chuyến & Đếm ngược 30 giây | UC-01 | AC-MCH-01 | TC-MCH-003 |
| **BG-04** | BR-007, BR-023 | **FR-MATCH-04** | Xử lý chấp nhận chuyến xe (Atomic Lock) | UC-01 | AC-MCH-02 | TC-MCH-003 |
| **BG-04** | BR-020, BR-021 | **FR-MATCH-05** | Xoay vòng tài xế kế tiếp khi từ chối/timeout | UC-01 | AC-MCH-03 | TC-MCH-004, TC-MCH-005 |
| **BG-04, BG-08** | BR-022 | **FR-MATCH-06** | Xử lý kết thúc tìm kiếm khi hết 5 lượt retry | UC-01 | AC-MCH-03 | TC-BOOK-004, TC-MCH-006 |
| **BG-06** | BR-024, BR-026 | **FR-PAY-01** | Tính toán cước phí thực tế tự động (`BRULE-01`) | UC-03 | AC-PAY-01, AC-PAY-02 | TC-PAY-001 |
| **BG-06, BG-09** | BR-026 | **FR-PAY-02** | Cấu hình biểu phí dịch vụ theo loại xe | UC-10 | AC-ADM-02 | TC-EST-002, TC-EST-003 |
| **BG-03, BG-06** | BR-027, BR-034 | **FR-PAY-03** | Khởi tạo giao dịch thanh toán Tiền mặt | UC-03 | AC-PAY-01 | TC-PAY-002 |
| **BG-03, BG-06** | BR-027 | **FR-PAY-04** | Tài xế xác nhận đã nhận đủ tiền mặt từ khách | UC-03 | AC-PAY-01 | TC-PAY-002, TC-PAY-005 |
| **BG-03, BG-12** | BR-028 | **FR-PAY-05** | Xử lý thanh toán Điện tử qua Mock Gateway | UC-03 | AC-PAY-02 | TC-PAY-003 |
| **BG-03, BG-11** | BR-029 | **FR-PAY-06** | Xử lý sự cố thanh toán điện tử thất bại (`EX-07`) | UC-03 | AC-PAY-02 | TC-PAY-004 |
| **BG-03, BG-05** | BR-030 | **FR-PAY-07** | Xuất hóa đơn điện tử & Gửi biên lai email | UC-03 | AC-PAY-02 | TC-PAY-006 |
| **BG-05, BG-07** | BR-015 | **FR-TRACK-01** | Thu nhận & Cập nhật tọa độ GPS định kỳ 5-10s | UC-06 | AC-TRK-02 | TC-TRK-001, TC-TRK-004 |
| **BG-05, BG-13** | BR-008 | **FR-TRACK-02** | Phát sóng vị trí xe cho khách hàng theo dõi | UC-02 | AC-TRK-02 | TC-TRK-002 |
| **BG-05, BG-13** | BR-007, BR-008 | **FR-TRACK-03** | Tính toán lại thời gian dự kiến xe đến (ETA) | UC-01, UC-02 | AC-TRK-02 | TC-TRK-003 |
| **BG-05, BG-09** | BR-037 | **FR-TRACK-04** | Hiển thị toàn cảnh bản đồ xe cho Operator | UC-09 | AC-ADM-03 | TC-TRK-002, TC-ADM-001 |
| **BG-08** | BR-031, BR-032 | **FR-NOTIF-01** | Bắn thông báo đẩy In-App thời gian thực (Socket) | UC-01, UC-02 | AC-MCH-02, AC-RIDE-01 | TC-RIDE-001, TC-MCH-003 |
| **BG-08** | BR-031, BR-033 | **FR-NOTIF-02** | Gửi email thông báo tự động không đồng bộ | UC-03, UC-04 | AC-AUTH-01, AC-PAY-02 | TC-REG-001, TC-PAY-003 |
| **BG-08, BG-13** | BR-031 | **FR-NOTIF-03** | Hộp thư thông báo trong ứng dụng | UC-01, UC-06 | AC-AUTH-01 | TC-ACC-001, TC-RIDE-001 |
| **BG-08, BG-13** | BR-031 | **FR-NOTIF-04** | Đánh dấu đã đọc thông báo | UC-01, UC-06 | AC-AUTH-01 | TC-ACC-001 |
| **BG-11** | BR-033, BR-045 | **FR-NOTIF-05** | Kiến trúc mở rộng kênh thông báo (Provider) | UC-01, UC-03 | AC-AUTH-01 | TC-RIDE-001, TC-MCH-003 |
| **BG-05, BG-13** | BR-034 | **FR-RATE-01** | Gửi đánh giá sao (1-5★) và nhận xét sau chuyến | UC-08 | AC-RAT-01 | TC-RAT-001, TC-RAT-002, TC-RAT-003, TC-RAT-005 |
| **BG-05, BG-07** | BR-034 | **FR-RATE-02** | Tự động tính toán lại Rating trung bình tài xế | UC-08 | AC-RAT-01 | TC-RAT-004 |
| **BG-07, BG-13** | BR-035 | **FR-RATE-03** | Tài xế xem danh sách phản hồi từ khách hàng | UC-06, UC-08 | AC-RAT-01 | TC-RAT-001, TC-RAT-004 |
...
| **BG-07, BG-09** | BR-016, BR-036 | **FR-ADM-03** | Quản lý danh sách Tài xế & Phương tiện | UC-04, UC-09 | AC-DRV-02 | TC-APP-001, TC-DRV-001 |
| **BG-09** | BR-037, BR-043 | **FR-ADM-04** | Giám sát & Can thiệp xử lý chuyến đi lỗi | UC-09 | AC-ADM-01 | TC-ADM-005 |
| **BG-03, BG-09** | BR-038 | **FR-ADM-05** | Tra cứu nhật ký giao dịch đối soát tài chính | UC-09, UC-11 | AC-ADM-03 | TC-PAY-003, TC-ADM-003 |
| **BG-03, BG-10** | BR-040 | **FR-ADM-06** | Báo cáo Thống kê Doanh thu theo xe & kênh TT | UC-11 | AC-ADM-03 | TC-ADM-003 |
| **BG-02, BG-10** | BR-040 | **FR-ADM-07** | Báo cáo Tỷ lệ Hoàn thành & Phân tích cuốc hủy | UC-11 | AC-ADM-03 | TC-ADM-001, TC-CNC-001 |
| **BG-07, BG-10** | BR-040 | **FR-ADM-08** | Báo cáo Đánh giá Hiệu quả hoạt động Tài xế | UC-11 | AC-ADM-03 | TC-RAT-004, TC-ADM-001 |
| **BG-12** | BR-039, BR-041 | **FR-SEC-01** | Kiểm tra quyền truy cập theo vai trò (RBAC) | UC-05, UC-09 | AC-ADM-01 | TC-AUTH-015, TC-APP-004, TC-ADM-004 |
| **BG-09, BG-12** | BR-039 | **FR-SEC-02** | Phân tách quyền nghiêm ngặt Operator vs Admin | UC-09, UC-10 | AC-ADM-01 | TC-APP-004, TC-ADM-004 |
| **BG-12** | BR-043 | **FR-SEC-03** | Ghi nhật ký kiểm toán bất biến (Audit Log) | UC-04, UC-10 | AC-ADM-02 | TC-APP-002, TC-ADM-005 |
| **BG-12** | BR-042 | **FR-SEC-04** | Mã hóa mật khẩu (`bcrypt`) & Dữ liệu nhạy cảm | UC-05 | AC-AUTH-01 | TC-AUTH-014, TC-AUTH-020 |
| **BG-11** | BR-044, BR-045 | **FR-SEC-05** | Cơ chế cách ly lỗi thành phần (Circuit Breaker) | UC-01, UC-03 | AC-PAY-02 | TC-PAY-004, TC-MCH-006 |
